...
exports.cryptoPaymentRoute = void 0;
...
exports.cryptoPaymentRoute = router;
router
    .route('/')
...
router
    ...
    .patch((0, auth_1.default)('manageUsers'), (0, validate_1.Validate)(Validation_1.default.update()), (0, AsyncHandler_1.AsyncHandler)(Controller_1.default.update));
