...
class Controller {
     ...
     * @param req
     * @param res
      @Route {Query GameLeague}
     */
    query(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const filter = (0, pick_1.Pick)(req.query, ["gameTypeId", "gameModeId", "status"]);
