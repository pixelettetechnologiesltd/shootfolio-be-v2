...
class Service {
    ...
    create(body) {
        return __awaiter(this, void 0, void 0, function* () {
            if (body.admin !== null && body.admin !== undefined) {
                if ((yield model_1.default.countDocuments({
                    club: body.club,
                    admin: { $ne: null },
                })) >= 5) {
                    throw new badRequest_error_1.BadRequestError("You can not create more then 5 portfolios for single club");
                }
            }
    ...
    get(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!doc) {
                throw new badRequest_error_1.BadRequestError("Portfolio not found");
            }
            return doc;
        });
    }
