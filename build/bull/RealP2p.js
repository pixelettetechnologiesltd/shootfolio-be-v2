...
exports.realTimePlayerToPlayerGameScheduler = void 0;
const interface_1 = require("../modules/Games/entity/interface");
const conf_1 = require("./conf");
function realTimePlayerToPlayerGameScheduler(gameId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            console.log(`Game analytics for Real Time P2P comparison job scheduled for game with ID ${gameId}. Job ID: ${job.id}`);
            return;
        }
        catch (error) {
            console.log(error);
...
exports.realTimePlayerToPlayerGameScheduler = realTimePlayerToPlayerGameScheduler;
